...
define("FILEIO_PARAMETER", serialize(array('2lime.net', 21, 'limenet', '7yy9M0X1aw', 'PASV', '/www/img/', 'http://img.2lime.net/', true))); // FileIO參數 (FTP)
